...
features = np.load('data/text_features_bert_base.npy')  # text features of the items
# features = np.load('data/img_features_resnet50.npy')  # image features of the items
